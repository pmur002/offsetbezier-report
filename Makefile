...
TARFILE = ../offsetbezier-deposit-$(shell date +'%Y-%m-%d').tar.gz
...
docker:
	sudo docker run -v $(shell pwd):/home/work/ -w /home/work --rm pmur002/offsetbezier make offsetbezier.html

web:
	make docker
	cp -r ../offsetbezier-report/* ~/Web/Reports/VWline/offsetbezier/
